...
module.exports = View.extend({
    ...
    initialize: function() {
        ...
        this.$sit = $('<button class=btn>Sit</button>').attr('data-action', 'sit').appendTo(this.$wrapper);
        this.$bet = $('<button class=btn>Bet</button>').attr('data-action', 'bet').appendTo(this.$wrapper);
        this.$player = $('<div class=player>').appendTo(this.$wrapper);
        this.$chips = $('<div class=player>').appendTo(this.$wrapper);
        ...
        this.chips = new ChipsView({ model: new Backbone.Model({ value: this.model.get('bet') || null }), el: this.$chips }).render();
