...
var TableView = module.exports = View.extend({
	...
	initialize: function() {
        ...
        this.socket.on('turn', this.onSocketTurn);
        this.socket.on('sit', this.onSocketSit);
        ...
        this.socket.on('deal', this.onSocketDeal);
    ...
    onSocketEject: function(m, callback) {
    ...
    onSocketDeal: function(e, callback) {
        console.log('dealing cards to', e.boxes.length, 'boxes');

        this.model.set('state', 'dealing');
