App.CardsView = App.View.extend({
    ...
    reset: function(collection, options) {
        ...
        if (options.callback) {
            ...
            _.each(this.views, function(view) { this.remove(view.model, this.collection, options); });
    ...
    add: function(model, collection, options) {
        var view = new App.CardView({ model: model }, options);
